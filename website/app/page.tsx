...
const cadDownloads = [
  ["Fusion assembly · R10", "/downloads/GP_TARS_V2_R10.f3d", "F3D · Fusion document GPTars_v4, generated by cad/build_model.py"],
];
        ...
        <section className="hero" id="overview">
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              <a className="button primary" href="/downloads/GP_TARS_V2_R10.f3d">Download current Fusion model</a>
