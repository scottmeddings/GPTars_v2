...
const cadDownloads = [
  ["Fusion assembly · R08", "/downloads/GP_TARS_V2_R08.f3d", "F3D · current, generated by cad/build_model.py"],
];
        ...
        <section id="drawings">
          ...
          <div className="drawing-grid">
            <figure className="drawing drawing-main">
              ...
              <figcaption><b>General arrangement, R08.</b> Front and side elevations dimensioned: 480 × 1000 × 259.9 overall, 240 chassis, 116 leg-arm slabs, hip axis at 610.8, 174 × 310 display aperture and the 200 mm rockered sole.</figcaption>
            </figure>
