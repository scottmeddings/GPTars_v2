...
const packageRows = [
  ...
  [
    "Main actuator",
    `Ø${value("ACTUATOR_MAIN_PLACEHOLDER_DIAMETER")} × ${value("ACTUATOR_MAIN_PLACEHOLDER_LENGTH")} max`,
    "Four main joint zones",
    "Placeholder",
  ],
  [
    "Secondary actuator",
    `Ø${value("ACTUATOR_SECONDARY_PLACEHOLDER_DIAMETER")} × ${value("ACTUATOR_SECONDARY_PLACEHOLDER_LENGTH")}`,
    "Linkage zones",
    "Placeholder",
  ],
];
