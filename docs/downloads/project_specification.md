...
* use removable panels primarily as cosmetic bodywork

The mechanical structure must NOT rely on body panels of any material for primary structural loads.

> **Revision, 2026-08-10 — bodywork material superseded.** This specification
> originally called for printed PETG/ASA/CF cosmetic panels. Production bodywork
> is now formed 5052-H32 aluminium sheet. See `docs/aluminium_architecture.md`
> for the material schedule and the mass consequence recorded below.
>
> The load-path rule is unchanged and matters *more* under this decision: formed
> aluminium panels look structural and must still never be treated as such.
...
PANEL_MATERIAL =
5052-H32 aluminium sheet
```

Shell wall values are sheet gauges, not printed wall thicknesses. The superseded
printed specification was 3.0 mm nominal over a 2.5–4.0 mm range.
...
The formed aluminium exterior should bolt onto the structural chassis through
isolated fixings, never becoming part of the load path.
...
```text
1.0–1.6 mm formed 5052-H32 sheet, 1.2 mm nominal
```

Use folded returns, swaged beads and local doublers to control panel flex rather
than increasing gauge. Ribbing a printed panel and stiffening a sheet-metal panel
...
Use rivnuts, nut plates or captive fasteners in the sheet. Heat-set inserts no
longer apply now that the bodywork is metal.

Isolate the panels from the 6061-T6 chassis where dissimilar-metal or
fastener-bearing contact could cause galvanic corrosion or fretting.

Structural joints should use bolts into aluminium or steel.

## Mass consequence

A complete 1.2 mm skin over the rectangular envelope is approximately 9.4 kg
before formed returns, doublers and hardware, against a 12–25 kg total design
target. Panel geometry, openings and a controlled mass budget must therefore be
established before any bodywork is released. See `docs/interference_report.md`.
